...
class __TwigTemplate_ff1e1e256bf4ba53bc4d9f264170e9de06a9b4fcede4a570c06de8f0e86fa7d4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
        ...
        echo "\"><a";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "flag-link"], "method", false, false, true, 41), 41, $this->source), "html", null, true);
        ...
        echo "</span> <i class=\"fa ion-ios-heart-outline\"></i></a></div>
";
    ...
    {
        return new Source("", "themes/wosh/templates/flag/flag--wishlist.html.twig", "/Users/heenakhambra/sites/dd/themes/wosh/templates/flag/flag--wishlist.html.twig");
    }
