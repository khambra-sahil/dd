...
class __TwigTemplate_db553e7ac97e64cc40390b0f64c615fdc94fc5b96f0890963a7200b905f98ae9 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "nav menu menu-parent"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/wosh/templates/navigation/menu.html.twig", "/Users/heenakhambra/sites/dd/themes/wosh/templates/navigation/menu.html.twig");
    }
